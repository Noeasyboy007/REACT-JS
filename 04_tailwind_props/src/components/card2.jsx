...
function card2({ coreMembers ,btnText}) {
    return (
        <section>
            <div class="mx-auto max-w-7xl px-2 lg:px-0">
                <div class="mx-auto max-w-3xl text-center">
                    <h2 class="text-3xl font-bold leading-tight sm:text-lime-400 lg:text-5xl lg:leading-tight">
                        {coreMembers}
                    </h2>
                    <p class="mx-auto mt-4 max-w-2xl text-xl text-white">
